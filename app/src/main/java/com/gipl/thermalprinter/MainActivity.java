...
import com.gipl.escposprint.connection.tcp.TcpConnection;
import com.gipl.escposprint.connection.usb.UsbConnection;
import com.gipl.escposprint.connection.usb.UsbPrintersConnections;
import com.gipl.thermalprinter.async.AsyncBluetoothEscPosPrint;
import com.gipl.thermalprinter.async.AsyncEscPosPrint;
import com.gipl.thermalprinter.async.AsyncEscPosPrinter;
import com.gipl.thermalprinter.async.AsyncTcpEscPosPrint;
import com.gipl.thermalprinter.async.AsyncUsbEscPosPrint;
...
//        final BluetoothConnection[] bluetoothDevicesList = (new BluetoothPrintersConnections()).getList();
        final BluetoothConnection[] bluetoothDevicesList = new PrinterConnections().getList();
